      ...
      <div className='modal'>
        ...
        <div className='modal__content'>
          ...
          <div className="modal__content-description">
            ...
            <p className='modal__content-descriptionParagraph'>The Pokémon is a role-playing game based around building a small team of monsters to battle other monsters in a quest to become the best. Pokémon are divided into types, such as water and fire, each with different strengths.</p>
          </div>
